    ...
    <div class="row content">
        ...
        <div class='col-md-9'>
                ...
                <form action="<c:url value='/adminController/displayInvoices'/>" method="post">
                    <button class=" admin btn btn-default" type ="submit"> Process Invoices</button>
                </form>
                <form action="reports.jsp">
                    <button class=" admin btn btn-default" type ="submit"> Display Reports</button>
                    
                </form>
                <form action="<c:url value='/adminController/showProducts'/>" method="post">
                    <button class=" admin btn btn-default" type ="submit"> Products Management</button>
